...
class Agravo(models.Model):
    ...
    sinais_clinicos = models.ManyToManyField(SinaisClinicos, blank=True, default=None)
    doencas_pre_existentes = models.ManyToManyField(DoencasPreExistentes, blank=True, default=None)
